...
def create_conf(
    ...
    if os.path.exists(conf_path) and ignore_existing is False:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ignore_existing", help="Ignore existing conf file, and overwrite it.", action="store_true", required=False, default=False)
